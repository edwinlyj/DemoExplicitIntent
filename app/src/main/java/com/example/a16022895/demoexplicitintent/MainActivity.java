...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        smantv = findViewById(R.id.smantv);
        bmantv = findViewById(R.id.bmantv);

        smantv.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        bmantv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
